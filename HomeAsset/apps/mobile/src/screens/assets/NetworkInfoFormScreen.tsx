...
type Rt = RouteProp<AssetsStackParamList, 'NetworkInfoForm'>;
...
const NetworkInfoFormScreen: React.FC = () => {
  ...
  useEffect(() => {
    if (assetQuery.data?.networkInfo) {
      const n = assetQuery.data.networkInfo;
