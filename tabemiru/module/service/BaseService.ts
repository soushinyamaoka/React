...
export default class BaseService {
  ...
  public async send(req: any, file: File) {
    console.log("SEND")
    console.log(req)
  ...
  public async searchRecipe(req: any) {
  ...
  public async selectRecipe(req: any) {
    console.log("SEND")
    console.log(req)
    const axiosA = axios.post(this.getUrl(req.ReqCode), req)
    this.model = await axiosA;
  ...
  public add(model: any, setModel: any, keyNo: any, recipeId: any) {
  ...
  public upRow(n: any, model: any, setModel: any) {
    if (n - 1 < 0) return
  ...
  public downRow(n: any, model: any, setModel: any) {
  ...
  public delRow(n: any, model: any, setModel: any) {
  ...
  public onFileChange(e: React.ChangeEvent<HTMLInputElement>, setLocalFile: any, setFile: any) {
